<?php
/**
 * Script para consultar los géneros disponibles.
 * 
 * Devuelve una lista de géneros (ej. Masculino, Femenino).
 * Se utiliza en el formulario de registro o actualización de perfil.
 */
