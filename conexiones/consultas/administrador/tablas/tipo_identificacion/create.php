...
if (empty($descripcion)) {
    ...
    $sql = "INSERT INTO tipo_identificacion (descripcion) VALUES ('$descripcion')";
    $res = mysqli_query($link, $sql);
    
    if ($res) {
        echo json_encode(array("success" => "1", "mensaje" => "Tipo de identificación registrado correctamente"));
    } else {
