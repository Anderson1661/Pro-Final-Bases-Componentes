...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($data['id_conductor']) && isset($data['telefono'])) {
        ...
        $query_check = "SELECT COUNT(*) as count FROM telefono_conductor WHERE id_conductor = '$id_conductor' AND telefono = '$telefono'";
        ...
        if ($result_check) {
            ...
            if ($row['count'] == 0) {
                ...
                // Eliminar
                $query_delete = "DELETE FROM telefono_conductor WHERE id_conductor = '$id_conductor' AND telefono = '$telefono'";
        ...
        $response['success'] = "0";
        $response['mensaje'] = "ID de conductor y teléfono no proporcionados";
    }
} else {
    $response['success'] = "0";
