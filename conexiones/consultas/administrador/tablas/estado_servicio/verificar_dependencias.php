...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($data['id_estado_servicio'])) {
        ...
        // 1. Verificar en tabla ruta (rutas que tienen este estado)
        $query_rutas = "SELECT COUNT(*) as count FROM ruta WHERE id_estado_servicio = '$id_estado_servicio'";
        ...
        if ($total_dependencies > 0) {
            $response['success'] = "0";
            $response['mensaje'] = "No se puede eliminar el estado de servicio porque tiene dependencias en otras tablas";
