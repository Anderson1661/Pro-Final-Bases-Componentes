...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($data['id_color'])) {
        ...
        $query_vehiculos = "SELECT COUNT(*) as count FROM vehiculo WHERE id_color = '$id_color'";
        ...
        if ($total_dependencies > 0) {
            $response['success'] = "0";
            $response['mensaje'] = "No se puede eliminar el color de vehículo porque tiene dependencias en otras tablas";
