...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($data['id_administrador']) && isset($data['telefono'])) {
        ...
        $query_check = "SELECT COUNT(*) as count FROM telefono_administrador WHERE id_administrador = '$id_administrador' AND telefono = '$telefono'";
        ...
        if ($result_check) {
            ...
            if ($row['count'] == 0) {
                ...
                // Eliminar
                $query_delete = "DELETE FROM telefono_administrador WHERE id_administrador = '$id_administrador' AND telefono = '$telefono'";
        ...
        $response['success'] = "0";
        $response['mensaje'] = "ID de administrador y teléfono no proporcionados";
    }
} else {
    $response['success'] = "0";
