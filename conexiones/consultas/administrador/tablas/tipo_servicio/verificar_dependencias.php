...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($data['id_tipo_servicio'])) {
        ...
        // 1. Verificar en tabla vehiculo
        $query_vehiculos = "SELECT COUNT(*) as count FROM vehiculo WHERE id_tipo_servicio = '$id_tipo_servicio'";
        ...
        $query_rutas = "SELECT COUNT(*) as count FROM ruta WHERE id_tipo_servicio = '$id_tipo_servicio'";
        ...
        if ($total_dependencies > 0) {
            $response['success'] = "0";
            $response['mensaje'] = "No se puede eliminar el tipo de servicio porque tiene dependencias en otras tablas";
