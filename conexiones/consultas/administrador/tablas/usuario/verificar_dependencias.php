...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($data['id_usuario'])) {
        ...
        $query_respuestas = "SELECT COUNT(*) as count FROM respuestas_seguridad WHERE id_usuario = '$id_usuario'";
        ...
        if ($total_dependencies > 0) {
            $response['success'] = "0";
            $response['mensaje'] = "No se puede eliminar el usuario porque tiene dependencias en otras tablas";
