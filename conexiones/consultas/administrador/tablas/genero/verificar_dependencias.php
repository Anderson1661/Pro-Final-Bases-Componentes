...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($data['id_genero'])) {
        ...
        $query_clientes = "SELECT COUNT(*) as count FROM cliente WHERE id_genero = '$id_genero'";
        ...
        $query_administradores = "SELECT COUNT(*) as count FROM administrador WHERE id_genero = '$id_genero'";
        ...
        $query_conductores = "SELECT COUNT(*) as count FROM conductor WHERE id_genero = '$id_genero'";
        ...
        if ($total_dependencies > 0) {
            $response['success'] = "0";
            $response['mensaje'] = "No se puede eliminar el género porque tiene dependencias en otras tablas";
        ...
        $response['success'] = "0";
        $response['mensaje'] = "ID de género no proporcionado";
    }
} else {
    $response['success'] = "0";
