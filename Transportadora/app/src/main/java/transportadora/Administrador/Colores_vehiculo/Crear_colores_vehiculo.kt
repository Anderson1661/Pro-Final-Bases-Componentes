...
class Crear_colores_vehiculo : AppCompatActivity() {
    private lateinit var txtDescripcion: EditText

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_crear_colores_vehiculo)
    ...
    private fun crearColorVehiculo() {
        ...
        val url = ApiConfig.BASE_URL + "consultas/administrador/tablas/color_vehiculo/create.php"
        ...
        val request = JsonObjectRequest(
            ...
            { error ->
                Toast.makeText(this, "Error al crear color de vehículo: ${error.message}", Toast.LENGTH_SHORT).show()
            }
        )
