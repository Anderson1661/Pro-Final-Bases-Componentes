package transportadora.Administrador.Tel_clientes // Asegúrate de que el paquete sea correcto
...
class Editar_tel_clientes : AppCompatActivity() {
    ...
    private var idClienteOriginal: Int = 0
    private lateinit var telefonoOriginal: String // Usamos String para BIGINT

    // Data Class para almacenar los datos originales
    data class TelefonoClienteData(
        val id_cliente: Int,
        val telefono: String
    )
    private lateinit var datosOriginales: TelefonoClienteData
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        idClienteOriginal = intent.getIntExtra("id_cliente", 0)
        ...
        // Cargar los datos
        if (idClienteOriginal != 0 && telefonoOriginal.isNotEmpty()) {
    ...
    private fun cargarTelefonoAdministrador() {
        val url = ApiConfig.BASE_URL + "consultas/administrador/tablas/telefono_cliente/consultar_tel_cliente.php"
        val jsonObject = JSONObject().apply {
            put("id_cliente", idClienteOriginal)
            ...
            { response ->
                try {
                    if (response.getString("success") == "1") {
                        ...
                        datosOriginales = TelefonoClienteData(
                            id_cliente = datos.getInt("id_cliente"),
    ...
    private fun guardarCambios() {
        ...
        val url = ApiConfig.BASE_URL + "consultas/administrador/tablas/telefono_cliente/update.php"
        ...
        val request = JsonObjectRequest(
            ...
            { response ->
                try {
                    Log.d("EditarTelCliente", "Respuesta actualización: $response")
