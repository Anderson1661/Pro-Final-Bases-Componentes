...
class Crear_metodos_pago : AppCompatActivity() {
    private lateinit var txtDescripcion: EditText

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_crear_metodos_pago)
    ...
    private fun crearMetodoPago() {
        ...
        val url = ApiConfig.BASE_URL + "consultas/administrador/tablas/metodo_pago/create.php"
        ...
        val request = JsonObjectRequest(
            ...
            { error ->
                Toast.makeText(this, "Error al crear método de pago: ${error.message}", Toast.LENGTH_SHORT).show()
            }
        )
