...
class Crear_tipos_servicio : AppCompatActivity() {
    ...
    private fun crearTipoServicio() {
        ...
        val url = ApiConfig.BASE_URL + "consultas/administrador/tablas/tipo_servicio/create.php"
        ...
        val request = JsonObjectRequest(
            ...
            { error ->
                Toast.makeText(this, "Error al crear tipo de servicio: ${error.message}", Toast.LENGTH_SHORT).show()
            }
        )
