...
class Reporte4_admin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_reporte4_admin)
        initViews()
        setupRecyclerView()
        cargarDatosReporte()
    ...
    private fun cargarDatosReporte() {
        ...
        val url = ApiConfig.BASE_URL + "consultas/administrador/reportes/consultar_reporte4.php"
    ...
    inner class ReporteAdapter(private var datos: List<DatoReporte>) :
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ReporteViewHolder {
            val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.item_reporte4, parent, false)
