...
object Tipo_servicios_almacenados {
    suspend fun obtener_tipos_servicio(): List<Tipo_servicio> = withContext(Dispatchers.IO) {
        val url = ApiConfig.BASE_URL + "consultas/conductor/vehiculo/consultar_tipos.php"
