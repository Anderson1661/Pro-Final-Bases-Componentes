...
$allowed_fields = ['direccion_origen', 'direccion_destino', 'id_codigo_postal_origen', 'id_codigo_postal_destino', 'distancia_km', 'fecha_hora_reserva', 'fecha_hora_origen', 'fecha_hora_destino', 'id_conductor', 'id_tipo_servicio', 'id_cliente', 'id_estado_servicio', 'id_categoria_servicio', 'id_metodo_pago', 'total', 'pago_conductor'];
